  ...
  return (
    ...
    <div className="three"  >
        <ul className="three__caption" >
            ...
            <img src="/img/ind.webp"   className="three__photo" alt="Aire Acondicionado Split uno" />
        </ul>
        <ul className="three__caption">
            <img src="/img/ind-tres.webp" className="three__photo" alt="Aire Acondicionado Split tres" />
         </ul>
        <ul className="three__caption">
             <img src="/img/ind-dos.webp" className="three__photo" alt="Aire Acondicionado Split cuatro" />
         </ul>
  </div>
  {/* ))} */}
